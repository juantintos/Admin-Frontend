...
const PRIMENG = [
  ...
  DividerModule, InputNumberModule, FileUploadModule, TooltipModule,
  ProgressSpinnerModule,
];

@NgModule({
  imports: [CommonModule, RouterModule, ReactiveFormsModule, FormsModule, ...PRIMENG],
  exports: [CommonModule, RouterModule, ReactiveFormsModule, FormsModule, ...PRIMENG],
})
